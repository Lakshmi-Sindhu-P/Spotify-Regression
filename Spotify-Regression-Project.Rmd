...
output:
  html_document:
    output_dir: outputs  # Specifies the outputs folder for HTML
    df_print: paged
  pdf_document:
    output_dir: outputs  # Specifies the outputs folder for PDF
...
# Standardize genres using the recode function
spotify_data$genre <- recode(spotify_data$genre, !!!genre_mapping)

# Check if the genre column was updated
...
write.csv(spotify_data, "./data/modified_spotify_data.csv", row.names = FALSE)
